...
#include "clientreactor437838088.h"
#include "include/api/set.h"
void clientreactor437838088reaction_function_0(void* instance_args){
    _clientreactor437838088_self_t* self = (_clientreactor437838088_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    #line 152 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    LF_PRINT_DEBUG("Calling reaction function clientreactor437838088.reaction_function_0");
    PyObject *rValue = PyObject_CallObject(
        self->_lf_py_reaction_function_0, 
        Py_BuildValue("()")
    );
    if (rValue == NULL) {
        lf_print_error("FATAL: Calling reaction clientreactor437838088.reaction_function_0 failed.");
        if (PyErr_Occurred()) {
            PyErr_PrintEx(0);
...
#include "include/api/set.h"
void clientreactor437838088reaction_function_1(void* instance_args){
    _clientreactor437838088_self_t* self = (_clientreactor437838088_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    clientreactor437838088_global_parameter_t* global_parameter = self->_lf_global_parameter;
    int global_parameter_width = self->_lf_global_parameter_width; SUPPRESS_UNUSED_WARNING(global_parameter_width);
    clientreactor437838088_updated_parameters_t* updated_parameters = &self->_lf_updated_parameters;
    clientreactor437838088_num_train_samples_t* num_train_samples = &self->_lf_num_train_samples;
    #line 159 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    LF_PRINT_DEBUG("Calling reaction function clientreactor437838088.reaction_function_1");
    PyObject *rValue = PyObject_CallObject(
    ...
    if (rValue == NULL) {
        lf_print_error("FATAL: Calling reaction clientreactor437838088.reaction_function_1 failed.");
        if (PyErr_Occurred()) {
            PyErr_PrintEx(0);
            PyErr_Clear(); // this will reset the error indicator so we can run Python code again
        }
...
#include "include/api/set_undef.h"
_clientreactor437838088_self_t* new_clientreactor437838088() {
    _clientreactor437838088_self_t* self = (_clientreactor437838088_self_t*)_lf_new_reactor(sizeof(_clientreactor437838088_self_t));
    ...
    #line 149 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_0.function = clientreactor437838088reaction_function_0;
    #line 149 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    ...
    #line 157 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_1.function = clientreactor437838088reaction_function_1;
    #line 157 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
