...
#include "client21505853750_main.h"
#include "include/api/set.h"
void client21505853750_mainreaction_function_0(void* instance_args) {
    _client21505853750_main_main_self_t* self = (_client21505853750_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client2 {
    ...
    #line 176 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    /*Correspondence: Range: [(175, 8), (197, 27)) -> Range: [(0, 0), (22, 27)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf)*/// **** This reaction is unordered.
...
#include "include/api/set.h"
void client21505853750_mainreaction_function_1(void* instance_args) {
    _client21505853750_main_main_self_t* self = (_client21505853750_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client2 {
        clientreactor145684288_updated_parameters_t* updated_parameters;
    ...
    client21505853750_main_outputControlReactionTrigger_t* outputControlReactionTrigger = &self->_lf_outputControlReactionTrigger;
    ...
    client2.updated_parameters = self->_lf_client2.updated_parameters;
    #line 203 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    /*Correspondence: Range: [(202, 8), (211, 1)) -> Range: [(0, 0), (9, 1)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf)*/// **** This reaction is unordered.
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void client21505853750_mainreaction_function_2(void* instance_args) {
    _client21505853750_main_main_self_t* self = (_client21505853750_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client2 {
    ...
    #line 217 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    /*Correspondence: Range: [(216, 8), (238, 27)) -> Range: [(0, 0), (22, 27)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf)*/// **** This reaction is unordered.
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    // **** This reaction is unordered.
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void client21505853750_mainreaction_function_3(void* instance_args) {
    _client21505853750_main_main_self_t* self = (_client21505853750_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client2 {
        clientreactor145684288_num_train_samples_t* num_train_samples;
    ...
    _lf_replace_template_token((token_template_t*)outputControlReactionTrigger, (self->_lf__outputControlReactionTrigger.tmplt.token));
    client2.num_train_samples = self->_lf_client2.num_train_samples;
    #line 244 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    /*Correspondence: Range: [(243, 8), (252, 1)) -> Range: [(0, 0), (9, 1)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf)*/// **** This reaction is unordered.
    // If the output port has not been lf_set for the current logical time,
    // send an ABSENT message to the receiving federate
    LF_PRINT_LOG("Contemplating whether to send port "
              "absent for port %d to federate %d.",
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void client21505853750_mainreaction_function_4(void* instance_args) {
    _client21505853750_main_main_self_t* self = (_client21505853750_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client2 {
    ...
    // Expose the action struct as a local variable whose name matches the action name.
    client21505853750_main_networkMessage_4_t* networkMessage_4 = &self->_lf_networkMessage_4;
    // Set the fields of the action struct to match the current trigger.
    ...
    #line 258 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    /*Correspondence: Range: [(257, 8), (273, 27)) -> Range: [(0, 0), (16, 27)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf)*/// **** This reaction is unordered.
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    // **** This reaction is unordered.
...
_client21505853750_main_main_self_t* new_client21505853750_main() {
    _client21505853750_main_main_self_t* self = (_client21505853750_main_main_self_t*)_lf_new_reactor(sizeof(_client21505853750_main_main_self_t));
    ...
    #line 173 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_0.function = client21505853750_mainreaction_function_0;
    #line 173 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    ...
    #line 200 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_1.function = client21505853750_mainreaction_function_1;
    #line 200 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    ...
    #line 214 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_2.function = client21505853750_mainreaction_function_2;
    #line 214 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    ...
    #line 241 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_3.function = client21505853750_mainreaction_function_3;
    #line 241 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    ...
    #line 255 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
    self->_lf__reaction_4.function = client21505853750_mainreaction_function_4;
    #line 255 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client2.lf"
