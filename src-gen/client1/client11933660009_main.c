...
#include "client11933660009_main.h"
#include "include/api/set.h"
void client11933660009_mainreaction_function_0(void* instance_args) {
    _client11933660009_main_main_self_t* self = (_client11933660009_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client1 {
        clientreactor660737687_updated_parameters_t* updated_parameters;
    
    } client1;
    client1.updated_parameters = self->_lf_client1.updated_parameters;
    #line 177 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    /*Correspondence: Range: [(176, 8), (198, 27)) -> Range: [(0, 0), (22, 27)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf)*/// **** This reaction is unordered.
...
#include "include/api/set.h"
void client11933660009_mainreaction_function_1(void* instance_args) {
    _client11933660009_main_main_self_t* self = (_client11933660009_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client1 {
        clientreactor660737687_updated_parameters_t* updated_parameters;
    ...
    client11933660009_main_outputControlReactionTrigger_t* outputControlReactionTrigger = &self->_lf_outputControlReactionTrigger;
    ...
    client1.updated_parameters = self->_lf_client1.updated_parameters;
    #line 204 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    /*Correspondence: Range: [(203, 8), (212, 1)) -> Range: [(0, 0), (9, 1)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf)*/// **** This reaction is unordered.
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void client11933660009_mainreaction_function_2(void* instance_args) {
    _client11933660009_main_main_self_t* self = (_client11933660009_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client1 {
        clientreactor660737687_num_train_samples_t* num_train_samples;
    
    } client1;
    client1.num_train_samples = self->_lf_client1.num_train_samples;
    #line 218 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    /*Correspondence: Range: [(217, 8), (239, 27)) -> Range: [(0, 0), (22, 27)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf)*/// **** This reaction is unordered.
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    // **** This reaction is unordered.
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void client11933660009_mainreaction_function_3(void* instance_args) {
    _client11933660009_main_main_self_t* self = (_client11933660009_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client1 {
        clientreactor660737687_num_train_samples_t* num_train_samples;
    ...
    _lf_replace_template_token((token_template_t*)outputControlReactionTrigger, (self->_lf__outputControlReactionTrigger.tmplt.token));
    client1.num_train_samples = self->_lf_client1.num_train_samples;
    #line 245 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    /*Correspondence: Range: [(244, 8), (253, 1)) -> Range: [(0, 0), (9, 1)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf)*/// **** This reaction is unordered.
    // If the output port has not been lf_set for the current logical time,
    // send an ABSENT message to the receiving federate
    LF_PRINT_LOG("Contemplating whether to send port "
              "absent for port %d to federate %d.",
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void client11933660009_mainreaction_function_4(void* instance_args) {
    _client11933660009_main_main_self_t* self = (_client11933660009_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct client1 {
        clientreactor660737687_global_parameter_t* global_parameter;
    
    } client1;
    // Expose the action struct as a local variable whose name matches the action name.
    client11933660009_main_networkMessage_3_t* networkMessage_3 = &self->_lf_networkMessage_3;
    // Set the fields of the action struct to match the current trigger.
    ...
    #line 259 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    /*Correspondence: Range: [(258, 8), (274, 27)) -> Range: [(0, 0), (16, 27)) (verbatim=true; src=/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf)*/// **** This reaction is unordered.
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    // **** This reaction is unordered.
...
#include "include/api/set_undef.h"
_client11933660009_main_main_self_t* new_client11933660009_main() {
    _client11933660009_main_main_self_t* self = (_client11933660009_main_main_self_t*)_lf_new_reactor(sizeof(_client11933660009_main_main_self_t));
    ...
    #line 174 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    self->_lf__reaction_0.function = client11933660009_mainreaction_function_0;
    #line 174 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    ...
    #line 201 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    self->_lf__reaction_1.function = client11933660009_mainreaction_function_1;
    #line 201 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    ...
    #line 215 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    self->_lf__reaction_2.function = client11933660009_mainreaction_function_2;
    #line 215 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    ...
    #line 242 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    self->_lf__reaction_3.function = client11933660009_mainreaction_function_3;
    #line 242 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    ...
    #line 256 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
    self->_lf__reaction_4.function = client11933660009_mainreaction_function_4;
    #line 256 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/client1.lf"
