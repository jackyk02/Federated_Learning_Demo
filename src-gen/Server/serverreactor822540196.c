...
#include "include/api/set.h"
void serverreactor822540196reaction_function_0(void* instance_args){
    _serverreactor822540196_self_t* self = (_serverreactor822540196_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    serverreactor822540196_global_parameter_t* global_parameter = &self->_lf_global_parameter;
    #line 151 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/Server.lf"
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    LF_PRINT_DEBUG("Calling reaction function serverreactor822540196.reaction_function_0");
    PyObject *rValue = PyObject_CallObject(
        self->_lf_py_reaction_function_0, 
        Py_BuildValue("(O)", convert_C_port_to_py(global_parameter, -2))
    );
    if (rValue == NULL) {
        lf_print_error("FATAL: Calling reaction serverreactor822540196.reaction_function_0 failed.");
        if (PyErr_Occurred()) {
            PyErr_PrintEx(0);
...
#include "include/api/set.h"
void serverreactor822540196reaction_function_1(void* instance_args){
    _serverreactor822540196_self_t* self = (_serverreactor822540196_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    serverreactor822540196_updated_parameters_t** updated_parameters = self->_lf_updated_parameters;
    int updated_parameters_width = self->_lf_updated_parameters_width; SUPPRESS_UNUSED_WARNING(updated_parameters_width);
    serverreactor822540196_num_train_samples_t** num_train_samples = self->_lf_num_train_samples;
    ...
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    LF_PRINT_DEBUG("Calling reaction function serverreactor822540196.reaction_function_1");
    PyObject *rValue = PyObject_CallObject(
    ...
    if (rValue == NULL) {
        lf_print_error("FATAL: Calling reaction serverreactor822540196.reaction_function_1 failed.");
        if (PyErr_Occurred()) {
            PyErr_PrintEx(0);
            PyErr_Clear(); // this will reset the error indicator so we can run Python code again
        }
...
#include "include/api/set_undef.h"
_serverreactor822540196_self_t* new_serverreactor822540196() {
    _serverreactor822540196_self_t* self = (_serverreactor822540196_self_t*)_lf_new_reactor(sizeof(_serverreactor822540196_self_t));
    #line 149 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/Server.lf"
    self->_lf__reaction_0.number = 0;
    #line 149 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/Server.lf"
    self->_lf__reaction_0.function = serverreactor822540196reaction_function_0;
    #line 149 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/Server.lf"
    ...
    #line 156 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/Server.lf"
    self->_lf__reaction_1.function = serverreactor822540196reaction_function_1;
    #line 156 "/mnt/c/Users/jacky/Desktop/Federated_Learning/fed-gen/Main/src/Server.lf"
