...
void _lf_executable_preamble() {
    ...
    _fed.triggers_for_network_input_control_reactions_size = 4;
...
do { \
    ...
    _lf_action_table[1] = (lf_action_base_t*)&server_main_self[0]->_lf_networkMessage_0; \
    _lf_action_table[2] = (lf_action_base_t*)&server_main_self[0]->_lf_networkMessage_1; \
    _lf_action_table[3] = (lf_action_base_t*)&server_main_self[0]->_lf_networkMessage_2; \
    ...
    /* Add trigger server_main_self[0]->_lf__inputControlReactionTrigger_0 to the global list of network input ports. */ \
    _fed.triggers_for_network_input_control_reactions[1]= \
        &server_main_self[0]->_lf__inputControlReactionTrigger_0; \
    /* Add trigger server_main_self[0]->_lf__inputControlReactionTrigger_1 to the global list of network input ports. */ \
    _fed.triggers_for_network_input_control_reactions[2]= \
        &server_main_self[0]->_lf__inputControlReactionTrigger_1; \
    /* Add trigger server_main_self[0]->_lf__inputControlReactionTrigger_2 to the global list of network input ports. */ \
